...
DEFAULT_QFF_OHLCV_PATH = paths.QFF1_1M
DEFAULT_TSM_OHLCV_PATH = paths.TSMUSDTP_1M
DEFAULT_USDTTWD_OHLCV_PATH = paths.USDTTWD_1M

# A bare `python scripts/backtest/engine.py` is a scratch run; anything worth
# keeping should get its own --run-tag so the outputs land in their own
# directory next to the parameters that produced them.
DEFAULT_RUN = paths.run_dir("scratch")
DEFAULT_EQUITY_PATH = DEFAULT_RUN / "equity.csv"
DEFAULT_TRADES_PATH = DEFAULT_RUN / "trades.csv"
DEFAULT_SUMMARY_PATH = DEFAULT_RUN / "summary.json"
...
# all of them -- backtest/scaled.py passes its own ScaledParams and
