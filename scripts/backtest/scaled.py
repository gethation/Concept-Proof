...
The single-position engine in backtest/engine.py is imported for all
...
from backtest import engine as base  # noqa: E402
...
# The QFF/TSM 15m z-score is not currently built by features/spread.py, which
# ships 1m for this pair; the default names the canonical location it would
# occupy rather than a directory that no longer exists.
DEFAULT_INPUT_PATH = paths.feature("qff_tsm", "zscore_15m")
DEFAULT_QFF_OHLCV_PATH = paths.QFF1_15M
DEFAULT_TSM_OHLCV_PATH = paths.OKX_TSMUSDTP_15M
DEFAULT_USDTTWD_OHLCV_PATH = paths.USDTTWD_15M
_RUN = paths.run_dir("qff_tsm_scaled_15m")
DEFAULT_EQUITY_PATH = _RUN / "equity.csv"
DEFAULT_TRADES_PATH = _RUN / "trades.csv"
DEFAULT_SUMMARY_PATH = _RUN / "summary.json"
