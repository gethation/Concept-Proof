...
# occupy, so a run without --zscore-path fails pointing at the path to produce
# rather than at a directory that no longer exists.
DEFAULT_ZSCORE_PATH = paths.feature("qff_tsm", "zscore_15m")
DEFAULT_TRADES_PATH = paths.run_dir("qff_tsm_15m_best") / "trades.csv"
DEFAULT_OUT = paths.RUNS / "_grids" / "ou_optimal_thresholds_15m.json"
